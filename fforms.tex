...
\item
  ...
  \tightlist
  \item
    Cluster 1 : nn, rw, theta
  \item
    Cluster 2: ARMA/AR/MA, ETS-notrend, ETS-damped trend, ETS-notrendnoseasonal, wn
  \item
    CLuster 3: rwd
  \item
    Cluster 4: ARIMA, ETS-trend
    \textbackslash{}end\{item\}
  \end{enumerate}
...
\item
  ...
  \tightlist
  \item
    Cluster 1: SARIMA, tbats, theta
  \item
    Cluster 2: nn, rw, stlar
  \item
    Cluster 3: ARIMA, ARMA/AR/MA, ETS-dampedtrend, ETS-notrendnoseasonal, ETS-trend, rw, wn
  \item
    Cluster 4: ETS-dampedtrendseasonal, ETS-seasonal, ETS-trendseasonal, snaive
  \end{enumerate}
\end{itemize}
...
\caption{Visualization of vote matrix of yearly series. The X-axis denotes the class labels.}\label{fig:heaty}
\end{figure}
...
\caption{Visualization of vote matrix of monthly series. The X-axis denotes the class labels.}\label{fig:unnamed-chunk-1}
\end{figure}
