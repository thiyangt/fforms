...
\textbf{Reproducibility:} All the code and data used in this paper is available at \url{https://github.com/thiyangt/fforms}. The R packages ggplot2 \autocite{ggplot} and provides the basis for graphics. The document is written in knitr \autocite{xie2017dynamic}.
