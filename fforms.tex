...
\textbf{Reproducibility:} All the code and data used in this paper is available at \url{https://github.com/thiyangt/fforms}.

\textbf{Software:} R-package \texttt{seer} consists of the implementation of FFORMS algorithm is available from Github (\url{https://github.com/thiyangt/seer}).

\textbf{R-packages:} The R packages \textcite{ggplot} provides the basis for graphics. The document is written in \textcite{xie2017dynamic}.
