...
- According to \autoref{fig:heatyearly}, \autoref{fig:heatmonthly} and \autoref{fig:heathourly}, in general we can see the columns are clustered accroding to the similarities of the models as summarized in . This indicates our meta-learner correctly ientified the simmilarities and dissimilarities between classes.
