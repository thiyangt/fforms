...
**Reproducibility:** All the code and data used in this paper is available at https://github.com/thiyangt/fforms. The R packages ggplot2 [@ggplot] and  provides the basis for graphics. The document is written in knitr [@xie2017dynamic].
...
**Interactive dashboard visualisation:** showcasing vote matrices is available online at  https://thiyangt.github.io/fformsviz/fforms.html
