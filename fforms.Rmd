...
**R-package seer:** R-package oddstream consists of the implementation of FFORMS algorithm is available from Github (https://github.com/thiyangt/seer).

**R-packages:** Each of the R packages used in this article (ggplot2 (Wickham 2009), dplyr (Wickham
et al. 2017), tibble (Müller & Wickham 2017), tidyr (Wickham & Henry 2017), reshape (Wickham
2007)) are available online (URLs are provided in the bibliography).
