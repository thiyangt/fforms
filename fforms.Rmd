...
Although the FFORMS framework could use any time series features, our current implementation uses the features shown in \autoref{feature}; these are defined in the Appendix. These features were chosen based on their demonstrated utility in @kang2017visualising and @MonManEtAl2020.
