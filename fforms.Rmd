...
1. We introduce an R (R Core Team 2019) package, `seer` [@seer] that implements the proposed framework and related functions. To the best of our knowledge `seer` is the first R package to implement the meta-learning framework for time series forecasting.
...
```{r framework, fig.cap="FFORMS (Feature-based FORecast-Model Selection) framework. The offline phase is shown in blue, the online phase is in red and the peeking inside FFORMS is shown in yellow.", out.width='110%'}
...
**Reproducibility:** All the code and data used in this paper is available at https://github.com/thiyangt/fforms.

**Software:** R-package `seer` consists of the implementation of FFORMS algorithm is available from Github (https://github.com/thiyangt/seer). 

**R-packages:** The R packages @ggplot provides the basis for graphics. The document is written in @xie2017dynamic.
