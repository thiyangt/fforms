...
# This is a plotly graph converted into static graph. The code to generate the graph is available at src/flexdashboardviz.R under pcayearlydb
knitr::include_graphics("images/pcayearly.png")
```
