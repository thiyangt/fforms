...
1. We introduce an R [@Rcore] package, `seer` [@seer] that implements the proposed framework and related functions. To the best of our knowledge `seer` is the first R package to implement the meta-learning framework for time series forecasting.
...
\caption{Visualization of vote matrix of yearly series. The X-axis denotes the class labels.}(\#fig:unnamed-chunk-1)
\end{figure}
...
\caption{Visualization of vote matrix of monthly series. The X-axis denotes the class labels.}(\#fig:unnamed-chunk-2)
\end{figure}
...
\caption{Visualization of vote matrix of hourly series. The X-axis denotes the class labels.}(\#fig:unnamed-chunk-3)
\end{figure}
